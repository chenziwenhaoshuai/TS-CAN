...
table. The remaining losses are ETTh2 at horizons 96, 192, and 336.

| Dataset | Horizon | TS-CAN | TimeMixer++ | MSE Result |
|---|---:|---:|---:|---|
| Weather | 96 | **0.151/0.198** | 0.155/0.205 | Win |
| Weather | 192 | **0.196/0.241** | 0.201/0.245 | Win |
| Weather | 336 | **0.237**/0.275 | 0.237/**0.265** | Win |
| Weather | 720 | **0.311/0.328** | 0.312/0.334 | Win |
| Electricity | 96 | **0.135**/0.231 | 0.135/**0.222** | Win |
| Electricity | 192 | **0.147**/0.243 | 0.147/**0.235** | Win |
| Electricity | 336 | **0.164**/0.266 | 0.164/**0.245** | Win |
| Electricity | 720 | **0.208/0.296** | 0.212/0.310 | Win |
| Traffic | 96 | **0.361**/0.261 | 0.392/**0.253** | Win |
| Traffic | 192 | **0.370**/0.271 | 0.402/**0.258** | Win |
| Traffic | 336 | **0.388**/0.279 | 0.428/**0.263** | Win |
| Traffic | 720 | **0.427**/0.292 | 0.441/**0.282** | Win |
| Exchange | 96 | **0.082/0.203** | 0.085/0.214 | Win |
| Exchange | 192 | **0.172/0.296** | 0.175/0.313 | Win |
| Exchange | 336 | **0.307/0.403** | 0.316/0.420 | Win |
| Exchange | 720 | **0.792/0.666** | 0.851/0.689 | Win |
| ETTh1 | 96 | **0.361/0.393** | 0.361/0.403 | Win |
| ETTh1 | 192 | **0.409/0.425** | 0.416/0.441 | Win |
| ETTh1 | 336 | **0.429**/0.434 | 0.430/**0.434** | Win |
| ETTh1 | 720 | **0.449**/0.467 | 0.467/**0.451** | Win |
| ETTh2 | 96 | 0.280/0.334 | **0.276/0.328** | Loss |
| ETTh2 | 192 | 0.345/0.383 | **0.342/0.379** | Loss |
| ETTh2 | 336 | 0.347/**0.393** | **0.346**/0.398 | Loss |
| ETTh2 | 720 | **0.392**/0.426 | 0.392/**0.415** | Win |
| ETTm1 | 96 | **0.286**/0.345 | 0.310/**0.334** | Win |
| ETTm1 | 192 | **0.332**/0.370 | 0.348/**0.362** | Win |
| ETTm1 | 336 | **0.369**/0.395 | 0.376/**0.391** | Win |
| ETTm1 | 720 | **0.422**/0.426 | 0.440/**0.423** | Win |
| ETTm2 | 96 | **0.168**/0.258 | 0.170/**0.245** | Win |
| ETTm2 | 192 | **0.228**/0.298 | 0.229/**0.291** | Win |
| ETTm2 | 336 | **0.280/0.330** | 0.303/0.343 | Win |
| ETTm2 | 720 | **0.357/0.388** | 0.373/0.399 | Win |
...
| Dataset | TS-CAN | TimeMixer++ | Result |
|---|---:|---:|---|
| M4 Yearly | **13.132/2.932**/0.771 | 13.179/2.934/**0.769** | 2/3 Win |
| M4 Quarterly | 9.890/**1.141/0.865** | **9.755**/1.159/0.865 | 2/3 Win |
| M4 Monthly | **12.338/0.901**/0.851 | 12.432/0.904/**0.841** | 2/3 Win |
| M4 Others | **4.501**/3.019/**0.950** | 4.698/**2.931**/1.010 | 2/3 Win |
| PEMS03 | 14.476/**13.397/23.292** | **13.990**/13.430/24.030 | 2/3 Win |
| PEMS08 | **13.721**/8.945/**23.011** | 13.810/**8.210**/23.620 | 2/3 Win |
