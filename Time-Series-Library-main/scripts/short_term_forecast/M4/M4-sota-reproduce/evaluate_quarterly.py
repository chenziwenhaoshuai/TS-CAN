#!/usr/bin/env python3
"""Evaluate an archived M4-Quarterly forecast with the project evaluator."""
...
TARGET = {"SMAPE": 9.755, "MASE": 1.159, "OWA": 0.865}
...
def main() -> None:
    ...
    metrics = evaluate_pattern(root, "Quarterly", forecast)
    wins = {
