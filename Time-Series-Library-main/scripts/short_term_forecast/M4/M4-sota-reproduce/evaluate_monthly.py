#!/usr/bin/env python3
"""Evaluate an archived M4-Monthly forecast with the project evaluator."""
...
TARGET = {"SMAPE": 12.432, "MASE": 0.904, "OWA": 0.841}
...
def main() -> None:
    ...
    root = (args.tslib_root or here.parents[3]).resolve()
    ...
    metrics = evaluate_pattern(root, "Monthly", forecast)
    wins = {
