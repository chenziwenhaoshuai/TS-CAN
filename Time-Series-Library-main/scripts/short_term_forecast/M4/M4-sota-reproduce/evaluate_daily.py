#!/usr/bin/env python3
"""Evaluate an archived M4-Daily forecast against the Table 17 Others target."""
...
def main() -> None:
    ...
    metrics = evaluate_pattern(root, "Daily", forecast)
    wins = {
    ...
    result = {
        ...
        "scope": "Daily subset compared to the TimeMixer++ Table 17 Others target",
