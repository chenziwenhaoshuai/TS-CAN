...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def _collect_test_predictions(self, test_data, test_loader):
        ...
        with torch.no_grad():
            for batch_x, batch_y, batch_x_mark, batch_y_mark in test_loader:
                ...
                if self.args.data != 'PEMS' and test_data.scale and self.args.inverse:
                    shape = batch_y.shape
    ...
    def _evaluate_test_metrics(self, test_data, test_loader):
        preds, trues = self._collect_test_predictions(test_data, test_loader)
